...
*/
const BotName = 'HAIKAL BOT'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/haichelheaven'; // Nama Instagramlu cok
const whatsapplu = 'Wa.me/'; // Nomor whatsapplu cok
const kapanbotaktif = 'Tergantung jaringan'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://www.youtube.com/channel/'; // OFFICIAL GRUP LU 2
const grupch3 = 'https://instagram.com/haichelheaven'; // OFFICIAL GRUP LU 3
//
